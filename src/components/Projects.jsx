...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      link: "https://drive.google.com/file/d/162magATBBWnDMg-krmXBuMN3i73jufn-/view?usp=drive_link",
      tech: ["Unity", "C#"],
      date: "Jan 2023",
      category: "VideoGame",
      image: "/VG4.1.jpg",
    ...
    },
    {
      ...
      link: "https://www.youtube.com/watch?v=N1rjROAsX2Y&t=1s&ab_channel=LauraCarrillo",
      tech: ["Java", "JSON", "VisualStudio"],
      category: "App",
      date: "Feb 2023 May 2023",
      image: "/daliaApp.png",
      hoverImages: ["/daliaApp.1.png","/daliaApp.2.png","/daliaApp.png"],
    },
    {
      ...
      tech: ["React.js", "CSS", "VisualStudio"],
      category: "WebPage",
      date: "Jan 2025",
      image: "/webPage.png",
  ...
  return (
    <section id="projects" className="bg-gray-100 py-16 px-10">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
  ...
  {selectedProject && (
    ...
    >
      ...
      >
        ...
        <p className="text-gray-500 mt-4 text-sm text-bold"> {selectedProject.date}</p>
        <p className="text-sm text-gray-500 mt-2">
          <span className="inline-block bg-orange-200 text-orange-800 px-2 py-1 rounded-md">
            {selectedProject.tech.join(" / ")}
          </span>
        </p>
        <div className="description-container max-h-24 overflow-y-auto mt-4">
